...
|---------------:|:----------------------|:----------------------|:---------|-------------------:|-------------:|----------------------:|
|              1 | +6.24 pp              | +4.08 pp              | -2.16 pp |              1.944 |        0.32  |                28.473 |
|              2 | +8.51 pp              | +3.29 pp              | -5.22 pp |              2.883 |        0.618 |                15.793 |
|              3 | +13.22 pp             | +5.06 pp              | -8.16 pp |              3.824 |        0.913 |                11.992 |
|              5 | +16.03 pp             | +16.85 pp             | +0.82 pp |              5.677 |        1.421 |                10.412 |
...
**No teto de referência a camada custa -2.16 pp de excesso.** Isso não a reprova: a régua 28.0 não contém resultado, e as duas sleeves passaram pelos quatro itens dela antes de o backtest rodar. O que o número faz é dimensionar o custo da decisão.
...
**E a grade de tetos deveria separar as duas coisas.** Se a camada perdesse por si, o Δ seria negativo em toda a grade; se perdesse por disputar o teto, melhoraria conforme o teto afrouxa. Medido: teto 1: -2.16 pp · teto 2: -5.22 pp · teto 3: -8.16 pp · teto 5: +0.82 pp.
...
⚠️ **O G4 é BRUTO de custo e sem teto.** Ele mede o `dw` pedido (Σ|dw| mediano 2.54), então não é o retorno de uma carteira executável — é o sinal da estratégia. O custo aparece na seção 1, onde o breakeven da entrega com a camada é de 28.5 bps por lado contra os 2 bps premissados.
