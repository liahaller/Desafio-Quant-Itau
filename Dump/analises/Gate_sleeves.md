...
|:------------------------------|----------:|:------------------------|:-----------------------|:------------------|:----------------------------|:-----------|:----------------------------|
| C1a revisão M3 (nº de cortes) |       209 | 2025-02-11 → 2025-12-10 | 0.04565 cortes         | 0.5×              | SPY -4.20 ❌ · TLT +0.03 ✅ | ❌         | -0.16 (entropia CPI (15b))  |
| C1b revisão da reunião (bps)  |       334 | 2025-02-11 → 2026-06-17 | 0.2493 bps             | 0.2×              | SPY -2.75 ❌ · TLT -3.44 ❌ | ❌         | -0.24 (divergência da 2.3)  |
| C2a cauda da PMF de CPI       |       289 | 2025-02-11 → 2026-07-29 | 0.1953 prob.           | 19.5×             | SPY +0.45 ❌ · TLT -1.31 ❌ | ❌         | -0.68 (entropia CPI (15b))  |
...
| controle D16 · drift CPI 🛑   |        14 | 2025-03-12 → 2026-07-14 | 1 bps                  | 1.0×              | TIP +0.21 ✅ · TLT +1.31 ❌ | ❌         | +0.47 (divergência da 2.2)  |
...
|:------------------------------|---------------:|--------------------------:|--------------------------:|--------------------------:|---------------------------:|
| C1a revisão M3 (nº de cortes) |            209 |                      0.09 |                     -0.05 |                     -0.16 |                       0.11 |
| C1b revisão da reunião (bps)  |            324 |                     -0.01 |                     -0.24 |                     -0.03 |                       0.08 |
| C2a cauda da PMF de CPI       |            289 |                      0.04 |                      0.1  |                     -0.68 |                      -0.06 |
| C2b cauda da PMF de reunião   |            334 |                     -0.16 |                     -0.02 |                     -0.01 |                       0.58 |
| controle D16 · drift FOMC 🛑  |             17 |                     -0.06 |                      0.72 |                      0.44 |                       0.67 |
| controle D16 · drift CPI 🛑   |             12 |                      0.47 |                      0.04 |                     -0.09 |                      -0.34 |
...
**O gate está calibrado — o controle reproduz a D16 número a número.** As duas sleeves reprovadas saem com `SPY +4.91 ❌ · TLT +1.37 ❌` e `TIP +0.21 ✅ · TLT +1.31 ❌`, que são os mesmos μ de `Tatica_reconstruida.md`. Se o controle não reproduzisse, o errado seria o gate, não os candidatos.
...
**O único sinal com dispersão de verdade é a cauda do CPI (19.5×), e ela morre nos outros dois critérios.** No G2 o μ sai invertido nos DOIS ativos do livro (`SPY +0.45 ❌ · TLT -1.31 ❌`, contra a premissa declarada "SPY cai, TLT sobe"), e pela D2b não se inverte. No G3 ela correlaciona -0.68 (entropia CPI (15b)) — massa de cauda e entropia são o mesmo sinal com dois nomes, então ligar esta sleeve com a view 15b seria a dupla contagem da 15a.

> ⚠️ **Ressalva no G1 da cauda, contra o próprio candidato:** a média expansiva atravessa a troca de mercado, e a grade do CPI muda de 3 a 9 baldes entre meses — parte do 19.5× é degrau de grade, não sinal. A 15b demeana POR FAMÍLIA e normaliza a entropia por log(nº de baldes) justamente por isso. Não muda o veredito: a linha já morre no G2 e no G3, que não dependem da escala do sinal.
