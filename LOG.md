...
- **Três achados novos para a reunião**, todos em `Dump/analises/Premissa_taticas.md`: a âncora da 1.3 não aparece na amostra; o gap de fim de semana troca de sinal entre setores; o livro de RF do drift é truncado sempre. A `Pauta_reuniao_explicada.md` **não** foi atualizada com eles nesta sessão.
